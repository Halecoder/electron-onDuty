<template>
          ...
          <div class="shift-content">
            <div class="day-section">
              ...
              <div class="person-tags">
                ...
                <el-button
                  size="small"
                  @click="showPersonSelector(shift.id, 'monday')"
                  :icon="Plus"
                >
                  添加人员
                </el-button>
            ...
            <div class="day-section">
              ...
              <div class="person-tags">
                ...
                <el-button
                  size="small"
                  @click="showPersonSelector(shift.id, 'friday')"
                  :icon="Plus"
                >
                  添加人员
                </el-button>
  ...
  const availablePersons = computed(() => {
    ...
    const currentDayPersons = currentDay.value === 'monday'
      ? currentShift.mondayPersonIds
      : currentShift.fridayPersonIds
  ...
  async function saveShift() {
    ...
    try {
      const maxOrder = props.shifts.length > 0
        ? Math.max(...props.shifts.map(s => s.order))
        : 0
