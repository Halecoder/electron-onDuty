  ...
  <div class="basic-data-manager">
    ...
    <el-card class="basic-card">
      ...
      <el-form :model="form" label-width="200px">
        ...
        <el-form-item label="周末排班特殊人员索引">
          <el-input-number
            v-model="form.weekendRotationIndex_1"
            :min="0"
            :max="999"
...
const form = reactive({
  baseWeek: '',
  weekendRotationIndex_1: 0,
  weekendRotationIndex_2: 0
})
...
onMounted(() => {
  if (props.basicData) {
    ...
    form.weekendRotationIndex_1 = props.basicData.weekendRotationIndex_1
    form.weekendRotationIndex_2 = props.basicData.weekendRotationIndex_2
  }
})
...
async function saveBasicData() {
  ...
  try {
    await window.api.updateBasicData({
      ...
      weekendRotationIndex_1: form.weekendRotationIndex_1,
      weekendRotationIndex_2: form.weekendRotationIndex_2
    })
...
async function resetRotationIndex() {
  try {
    ...
    form.weekendRotationIndex_1 = 0
    form.weekendRotationIndex_2 = 0
    await saveBasicData()
  } catch (error) {
    // 用户取消
  }
